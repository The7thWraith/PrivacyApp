...
const DropdownOption: React.FC<DropdownOptionProps> = ({
	...
	return (
		<div className="mb-4">
			...
			<div
				className={`mt-1 bg-black w-full rounded-lg shadow-lg overflow-hidden transition-all duration-350 ease-in-out ${transitionClass} ${
					isOpen
					...
					<div
						...
						className={`px-4 py-3 cursor-pointer transition-colors duration-200 ${
							...
							value === option
								...
								: "text-gray-200 hover:bg-neutral-900"
						}`}
